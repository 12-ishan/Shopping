    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllAttributes','Delete these Attributes\'s details?','Are you sure you want to delete these Attributes\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('product-attributes.create')}}">
                                        ...
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Attribute</button>
                                    </a>
                ...
                <form method="post" id="deleteAllAttributes">

                    <div class="data-tables">
                        <table id="AttributesTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('product-attributes.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this attribute details?','Are you sure you want to delete this attribute details?');">Delete</a>
                                        </div>
                                    </td>
...
@section('js')
<script src="{{ asset('assets/admin/js/console/productAttribute.js') }}"></script>
@append
