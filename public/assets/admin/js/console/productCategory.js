$(document).ready(function () { 
    ...
    $("#deleteAllProductCategory").on('submit', (function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: '/admin/product-category/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>product category information  deleted successfully</p>');
                }
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/product-category/updateSortorder',
            data: {
