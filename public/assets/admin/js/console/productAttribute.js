$(document).ready(function () { 
    ...
    $("#deleteAllAttributes").on('submit', (function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: '/admin/product-attributes/destroyAll',
            type: 'post',
    ...
    table.on('row-reorder', function (e, diff, edit) {
        ...
        $.ajax({
            type: 'POST',
            url: '/admin/product-attributes/updateSortorder',
            data: {
    ...
    $('.status').change(function () {
        ...
        $.ajax({
            ...
            url: '/admin/product-attributes/updateStatus',
            dataType: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
...
function deleteRecord(id, title, message) {
    ...
    $("#deleteAllModalButton").on("click", function () {
        ...
        $.ajax({
            ...
            url: '/admin/product-attributes/destroy',
            dataType: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
